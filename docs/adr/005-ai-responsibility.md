...
Neorie は AI 機能を主要差別化として位置付ける。Anthropic API を利用して6つの場面で AI を組み込むが、モデル選定・使い分け・コスト管理の方針を確定する必要がある。コスト暴走のリスクと、ユーザー体験の品質確保を両立させる設計を行う。
...
| 案    | 概要                                           | 採否     | 理由                                                                                                                |
| ----- | ---------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------- |
| A     | stateless(1 ターン完結、履歴持たない)          | 棄却     | 連続質問不可で壁打ち体験が薄く、Neorie 主要用途を満たさない                                                         |
